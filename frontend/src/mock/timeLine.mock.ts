...
export const timelineData: Omit<TimelineItemProps, 'index'>[] = [
  ...
  {
    year: '1984',
    description: 'Adeeb Hussaini became a licensed lawyer in Damascus Syria.'
  },
  {
    year: '1987',
    description: 'HLG founded.'
  },
  {
    year: '2021',
    description: 'Mayada Hussaini became a licensed lawyer in Miami Florida.'
  },
  {
    year: '2023',
    description: 'Alaa Hussaini became a licensed lawyer in Amsterdam, the Netherlands.'
  },
  {
    year: '1st milestone',
  ...
  {
    year: '3rd milestone',
    description: 'Teaching at university'
  },
  {
    year: '4th milestone',
    description: 'PhD'
  ...
  {
    year: '5th milestone',
    description: 'Our book arbitration.'
  }
]